...
function C3({ nodes, materials, ...props }) {
    return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.logos_F1.geometry} material={materials['M_cintillaVF.002']} position={[-0.072, 0.256, 1.397]} rotation={[Math.PI / 2, 0, 0]} scale={1.549} />
    </group>
  )
}
