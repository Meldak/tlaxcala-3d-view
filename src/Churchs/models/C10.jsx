...
function C10({ nodes, materials, ...props }) {
    return (
    <group {...props} dispose={null}>
      <group position={[3.145, 0, 0.145]} rotation={[Math.PI / 2, 0, -Math.PI / 2]} scale={0.075}>
      ...
      <mesh geometry={nodes.logos_F1.geometry} material={materials['M_cintillaVF.002']} position={[-1.136, 0.193, 1.162]} rotation={[Math.PI / 2, 0, 0]} scale={1.367} />
    </group>
  )
}
