...
function C6({ nodes, materials, ...props }) {
    return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.logos_F1.geometry} material={materials['M_cintillaVF.002']} position={[-0.283, -0.225, 0.865]} rotation={[Math.PI / 2, 0, 0]} scale={1.242} />
    </group>
  )
}
