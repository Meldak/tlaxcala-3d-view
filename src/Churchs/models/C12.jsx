...
function C12({ nodes, materials, ...props }) {
    return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.logos_F1.geometry} material={materials['M_cintillaVF.002']} position={[-0.157, 0.323, 2.357]} rotation={[Math.PI / 2, 0, 0]} scale={1.965} />
    </group>
  )
}
