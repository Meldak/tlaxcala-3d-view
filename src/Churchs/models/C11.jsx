...
function C11({ nodes, materials, ...props }) {
    return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.logos_F1.geometry} material={materials['M_cintillaVF.002']} position={[0.026, 0.373, 4.567]} rotation={[Math.PI / 2, 0, 0]} scale={1.21} />
    </group>
  )
}
